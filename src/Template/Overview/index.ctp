...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Join in'), ['controller' => 'Attendance', 'action' => 'index']); ?></li>
	</ul>
	...
	<?php echo $this->Html->link('Please register first', ['controller' => 'Account', 'action' => 'register'])?>
	</p>
	<?php } ?>
</div>